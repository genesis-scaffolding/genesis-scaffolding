...
Guidelines for writing and maintaining documentation in the Genesis Scaffolding project.
...
- Include module/file references at the section level
- Cross-reference related documents rather than duplicating content
- Keep code snippets minimal — readers should read source code for exact syntax
