...
Step-by-step guides for extending and customizing the system.
...
- [create_workflow.md](./developer_guides/create_workflow.md) - Creating a new workflow manifest
- [create_workflow_step.md](./developer_guides/create_workflow_step.md) - Building new workflow task types
- [gotchas.md](./developer_guides/gotchas.md) - Common pitfalls and solutions