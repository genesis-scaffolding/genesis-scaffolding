...
- `genesis_core.persistent_memory` — Memory database models, service layer, and FTS5 search implementation
- `genesis_core.prompts` — Memory-related prompt fragments (e.g., `FRAGMENT_MEMORY`)
- `genesis_core.llm.token_utils` — Token counting implementation
