...
- `genesis_server.dependencies` — All dependency injection functions
- `genesis_server.routers.agents` — Agent management endpoints
- `genesis_server.routers.auth` — Authentication endpoints
- `genesis_server.routers.chat` — Chat and SSE streaming endpoints
- `genesis_server.routers.files` — File management endpoints
- `genesis_server.routers.jobs` — Workflow job endpoints
- `genesis_server.routers.llm_config` — LLM configuration endpoints
- `genesis_server.routers.memory` — Memory operations endpoints
- `genesis_server.routers.productivity` — Productivity CRUD endpoints
- `genesis_server.routers.schedules` — Schedule management endpoints
- `genesis_server.routers.users` — User account endpoints
- `genesis_server.routers.workflows` — Workflow manifest endpoints
