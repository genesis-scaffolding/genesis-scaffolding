...
from genesis_tools.pdf import convert_pdf_to_markdown
from genesis_tools.registry import tool_registry
...
class Agent:
    ...
    def _resolve_tools(self):
        ...
        try:
            ...
            # If genesis_tools is not available, agent simply has no tools
            self.tools = []
